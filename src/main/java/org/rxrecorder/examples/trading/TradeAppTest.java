...
public class TradeAppTest {
    ...
    public void test() throws IOException, InterruptedException {
        ...
        ConnectableObservable<Trade> tradeObservable1 = rxRecorder.replay(new ReplayOptions().filter("HT1"));
        ConnectableObservable<Trade> tradeObservable2 = rxRecorder.replay(new ReplayOptions().filter("HT2"));
